...
*Pipelines are how Company delivers infrastructure, software, custom
...
- Add the CodePipeline Pipeline resource itself, encoding
  ...
  - a 'Deploy' stage with an action that executes
    [this CFN template](https://github.com/jahidul2543/izaanschooldevops/blob/master/12-codepipeline/bucket.yaml)
